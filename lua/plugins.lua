...
packer.startup(function(use)
   ...
   -- NOTEnvim-cmp depends on lspkind-nvim
   use({
   ...
   use({
      ...
      cond = [[require("plugins.editing-support.registers.nvim-neoclip").cond()]],
      config = [[require("plugins.editing-support.registers.nvim-neoclip").config()]],
   })
   -- ╭────────────────────────────────────────────────────────────────────╮
   -- │                               motion                               │
   -- ╰────────────────────────────────────────────────────────────────────╯
